...
function ChatWindow({ recipient, onClose, minimized, setMinimized }) {
  ...
  useEffect(() => {
    ...
    socket.on('new_message', (message) => {
      if ((message.senderId === recipient.id && message.receiverId === user?.id) || 
  ...
  return (
    <div className="fixed bottom-0 right-8 w-80 bg-white rounded-t-lg shadow-lg z-50 border border-gray-200 flex flex-col" style={{ height: '400px' }}>
